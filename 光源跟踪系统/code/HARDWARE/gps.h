...
/*GPS信息解析,已包括所有信息解析函数
此处只解析RMC数据,已注释多余解析函数*/
void GPS_Analysis(nmea_msg *gpsx,u8 *buf);
void NMEA_GPGSV_Analysis(nmea_msg *gpsx,u8 *buf);//GPGSV解析
void NMEA_BDGSV_Analysis(nmea_msg *gpsx,u8 *buf);//BDGSV解析
void NMEA_GNGGA_Analysis(nmea_msg *gpsx,u8 *buf);//GNGGA解析 
void NMEA_GNGSA_Analysis(nmea_msg *gpsx,u8 *buf);//GPNSA解析
void NMEA_GNRMC_Analysis(nmea_msg *gpsx,u8 *buf);//GPRMC解析
void NMEA_GNVTG_Analysis(nmea_msg *gpsx,u8 *buf);//GPNTG解析
